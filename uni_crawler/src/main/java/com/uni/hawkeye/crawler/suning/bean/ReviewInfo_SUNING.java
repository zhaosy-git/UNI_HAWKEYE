...
public class ReviewInfo_SUNING {
	...
	public ReviewInfo_SUNING() {
	}

	public ReviewInfo_SUNING(String product_id_fk, int good_cnt, int general_cnt, int poor_cnt, float review_grade_avg, String review_json, int execute_id) {
		super();
