...
public class ReviewBadInfo_JD {
	...
	public ReviewBadInfo_JD(){}

	public ReviewBadInfo_JD(String review_bad_info, Date review_bad_time, String product_id_fk, String json, int execute_id) {
		super();
