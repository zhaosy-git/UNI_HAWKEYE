package com.uni.hawkeye.crawler.womai_phone.bean;
...
public class ReviewInfo_WOMAI {
	...
	public ReviewInfo_WOMAI(String product_id_fk, int good_cnt, int general_cnt, int poor_cnt, float review_grade_avg, String review_json, int execute_id) {
		super();
