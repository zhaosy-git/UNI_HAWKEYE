...
public class ReviewBadInfo_YHD {
	...
	public ReviewBadInfo_YHD(){}

	public ReviewBadInfo_YHD(String review_bad_info, Date review_bad_time, String from_way, String product_id_fk, String json, int execute_id) {
		super();
	...
	/**
	 * @param from_way the from_way to set
	 */
