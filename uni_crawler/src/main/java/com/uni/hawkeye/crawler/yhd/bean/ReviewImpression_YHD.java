...
public class ReviewImpression_YHD {
	...
	public ReviewImpression_YHD(){}

	public ReviewImpression_YHD(String impression_id, String product_id_fk, String impression_content, int impression_cnt, String json, int execute_id) {
		super();
