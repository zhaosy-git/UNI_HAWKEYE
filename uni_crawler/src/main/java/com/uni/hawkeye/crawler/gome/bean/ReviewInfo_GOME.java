...
public class ReviewInfo_GOME {
	...
	public ReviewInfo_GOME() {
	}

	public ReviewInfo_GOME(String product_id_fk, int good_cnt, int general_cnt, int poor_cnt, float review_grade_avg, String review_json, int execute_id) {
		super();
