...
public class BlockInfo {
	...
	private int weibo_search_id_fk;
	...
	public BlockInfo(int weibo_category_id_fk, int weibo_search_id_fk, String block_title, String block_text, String block_post_time, String block_weibo_url, String block_root_in,
			String block_user_id_fk, int block_repost_cnt, int block_comment_cnt, int block_favour_cnt, String parent_block_weibo_url, String block_at_username, String block_topic,
			String block_is_original) {
		super();
		this.weibo_category_id_fk = weibo_category_id_fk;
		this.weibo_search_id_fk = weibo_search_id_fk;
	 ...
	 *            the weibo_category_id_fk to set
	 */
	...
	/**
	 * @return the weibo_search_id_fk
	 */
	public int getWeibo_search_id_fk() {
		return weibo_search_id_fk;
	}

	/**
	 * @param weibo_search_id_fk
	 *            the weibo_search_id_fk to set
	 */
	public void setWeibo_search_id_fk(int weibo_search_id_fk) {
		this.weibo_search_id_fk = weibo_search_id_fk;
	}
	...
	/**
	 * @param block_post_time
	 *            the block_post_time to set
	 */
	...
	/**
	 * @param block_weibo_url
	 *            the block_weibo_url to set
	 */
	...
	/**
	 * @param block_user_id_fk
	 *            the block_user_id_fk to set
	 */
	...
	/**
	 * @param block_repost_cnt
	 *            the block_repost_cnt to set
	 */
	...
	/**
	 * @param block_comment_cnt
	 *            the block_comment_cnt to set
	 */
	...
	/**
	 * @param block_favour_cnt
	 *            the block_favour_cnt to set
	 */
	...
	/**
	 * @param parent_block_weibo_url
	 *            the parent_block_weibo_url to set
	 */
	...
	/**
	 * @param block_at_username
	 *            the block_at_username to set
	 */
	...
	/**
	 * @param block_is_original
	 *            the block_is_original to set
	 */
