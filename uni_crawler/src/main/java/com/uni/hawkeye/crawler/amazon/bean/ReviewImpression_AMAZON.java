package com.uni.hawkeye.crawler.amazon.bean;

import java.util.Date;

public class ReviewImpression_AMAZON {
	...
	public ReviewImpression_AMAZON(){}

	public ReviewImpression_AMAZON(String impression_id, String product_id_fk, String impression_content, int impression_cnt, String json, int execute_id) {
		super();
