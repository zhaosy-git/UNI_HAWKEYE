...
public class ReviewImpression_SUNING {
	...
	public ReviewImpression_SUNING(){}

	public ReviewImpression_SUNING(String impression_id, String product_id_fk, String impression_content, int impression_cnt, String json, int execute_id) {
		super();
