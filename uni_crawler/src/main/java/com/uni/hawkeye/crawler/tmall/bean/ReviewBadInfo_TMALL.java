...
public class ReviewBadInfo_TMALL {
	...
	private String review_impression_id_fk;
	...
	/**
	 * @return the review_impression_id_fk
	 */
	public String getReview_impression_id_fk() {
		return review_impression_id_fk;
	}

	/**
	 * @param review_impression_id_fk the review_impression_id_fk to set
	 */
	public void setReview_impression_id_fk(String review_impression_id_fk) {
		this.review_impression_id_fk = review_impression_id_fk;
	}
