...
public class PriceInfo_WOMAI {
	...
	public PriceInfo_WOMAI(){}

	public PriceInfo_WOMAI(String price_product_id_fk, int price_type, BigDecimal price, int product_list_id) {
		super();
