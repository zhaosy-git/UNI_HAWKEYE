...
public class ReviewInfo_WOMAI {
	...
	public ReviewInfo_WOMAI() {
	}

	public ReviewInfo_WOMAI(int execute_id, String product_id_fk, int good_cnt, int general_cnt, int poor_cnt, float review_grade_avg, String review_json) {
		super();
	...
	/**
	 * @param review_grade_avg
	 *            the review_grade_avg to set
	 */
