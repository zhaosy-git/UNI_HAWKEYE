...
public class ReviewBadInfo_GOME {
	...
	public ReviewBadInfo_GOME(){}

	public ReviewBadInfo_GOME(String review_bad_info, Date review_bad_time, String product_id_fk, String json, int execute_id) {
		super();
