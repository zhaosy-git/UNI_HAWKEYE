...
public class CategoryInfo {
	...
	public CategoryInfo(String category_code, String category_name, String category_level, int category_parent_id, String category_url, String status, int execute_id_fk) {
		super();
